...
public class TriangleLayer extends ShapeLayer{
    ...
    */
    public static class Builder extends ShapeLayer.Builder { 
        public String getDefaultName() { return "새 삼각형"; }
    ...
    */
    ...
    public Point2D.Double getVertex(int index) {
        switch (index) {
            case 0: return new Point2D.Double((getCentralPoint().getX()), (int)((getCentralPoint().getY() - getSize().getY() / 2)));
            case 1: return new Point2D.Double((getCentralPoint().getX() + getSize().getX() / 2), (int)((getCentralPoint().getY() + getSize().getY() / 2)));
            case 2: return new Point2D.Double((getCentralPoint().getX() - getSize().getX() / 2), (int)((getCentralPoint().getY() + getSize().getY() / 2)));
            default: return null;
        }
    }
